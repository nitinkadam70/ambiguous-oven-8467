...
export const HomePageSliderThree = () => {
    return (
        <Box maxW='100%' display='flex' justifyContent='space-between' p={5} justifyItems='center'>
            <Box>
                <UnorderedList fontSize='1.125rem' fontWeight='400' lineHeight='1.25' textAlign='justify' spacing={3}>
                    ...
                    <ListItem>Task automations</ListItem>
            ...
            <Box width={'609px'} h='342px'>
                ...
                maxH={'100%'}
                maxW="100%"
                src='https://www.bitrix24.in/upload/optimizer/converted/images/content_en/screens/main/header_banner/tasks.1366w.png.webp?1657634644000'/>
            </Box>
        </Box>
    )
}
