...
export default function SolutionPageComponents() {
    return (
        <Box
            ...
            <Container as={Stack} maxW={'6xl'} py={10}>
                <SimpleGrid columns={{ base: 1, sm: 2, md: 5 }} spacing={8}>
                    <Stack align={'flex-start'} spacing={8}>
                        <Image src='https://www.bitrix24.com/upload/optimizer/converted/images/features/landing/solutions/m1.png.webp?1658490569000' />
                        <ListHeader>By Role</ListHeader>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Marketing</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>HR</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Project Management</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Coustomer Service</Link>
                    </Stack>
                    <Stack align={'flex-start'} spacing={8}>
                        <Image src='https://www.bitrix24.com/upload/optimizer/converted/images/features/landing/solutions/m2.png.webp?1658490569000' />
                        <ListHeader>By Industry</ListHeader>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Legal</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Reatial</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Travel</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Transportion and Storage</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Restarant</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Remote Work</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>HR</Link>
                    </Stack>
                    <Stack align={'flex-start'} spacing={8}>
                        <Image src='https://www.bitrix24.com/upload/optimizer/converted/images/features/landing/solutions/m3.png.webp?1658490569000' />
                        <ListHeader>By need</ListHeader>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Mobility</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Productivity</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Communication</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Management and LeaderShip</Link>
                    </Stack>
                    <Stack align={'flex-start'} spacing={8}>
                        <Image src='https://www.bitrix24.com/upload/optimizer/converted/images/features/landing/solutions/m4.png.webp?1658490569000' />
                        <ListHeader>By tool</ListHeader>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>telephony</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Calendars</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>CRM</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Task and Projects</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Website Builder</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Contact center</Link>
                    </Stack>
                    <Stack align={'flex-start'} spacing={8}>
                        <Image src='https://www.bitrix24.com/upload/optimizer/converted/images/features/landing/solutions/m5.png.webp?1658490569000' />
                        <ListHeader>By Business Size</ListHeader>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Solo entrepreneur</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Small Buisness</Link>
                        <Link fontSize='18px' lineHeight='27px' letterSpacing='-.7px' color='#1ABDEF' href={'#'}>Enterprise</Link>
                    </Stack>
                </SimpleGrid>
            </Container>
